...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Person person1 = new Person("mahesh", "Mumbai");
        ProjectDB.add(person1);

        Person person2 = new Person("sahil", "banglore");
        ProjectDB.add(person2);

        Passenger passenger1 = new Passenger(person1, 1);
        ProjectDB.add(passenger1);

        FlightDescription flightDescription1 = new FlightDescription("Mumbai", "Kolkata", "01:00", "04:45", 100);
        ProjectDB.add(flightDescription1);

        FlightDescription flightDescription2 = new FlightDescription("Mumbai", "Delhi", "02:20", "03:45", 120);
        ProjectDB.add(flightDescription2);

        ScheduledFlight scheduledFlight1 = new ScheduledFlight(flightDescription1, "25/06/2024");
